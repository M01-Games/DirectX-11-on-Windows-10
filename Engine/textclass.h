...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext*, FontShaderClass*, const XMMATRIX&, const XMMATRIX&);
...
private:
	...
	bool RenderSentence(SentenceType*, ID3D11DeviceContext*, FontShaderClass*, const XMMATRIX&, const XMMATRIX&);
